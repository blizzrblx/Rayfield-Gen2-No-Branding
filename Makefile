# Convenience targets for the library.
...
PLACE_FILE ?= Library.rbxlx
TEST_PLACE_FILE ?= Library Tests.rbxlx
...
help:
	...
	@echo   test-verbose  Run unit tests with library logs enabled
...
bundle:
	...
	$(LUNE) run wax bundle output="$(BUNDLE_FILE)" input="$(WAX_PROJECT)" minify=true env-name=Library
